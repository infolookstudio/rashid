...
var PageTransitions = function (a) {
    ...
    function b() {
        ...
        var m = location.hash.substr(1),
            ...
            o = a('#portfolio_grid figure a')
            .each(function () {
                if (o = a(this)
                    .attr('href'), m == 'portfolio/' + o.substr(0, o.length - 5)) {
                    var p = a(this)
                        .attr('href');
                    return l(), n.load(p), !1
                }
            });
        a('.subpages .ajax-page-load')
            .click(function () {
                a(this)
                    .attr('href');
                return window.location.hash = 'portfolio/' + a(this)
                    .attr('href')
                    .substr(0, a(this)
                        .attr('href')
                        .length - 5), !1
    ...
    function d(l) {
        return '' === location.hash ? l ? l : '#' + a('.pt-page-current')
            .attr('data-id') : location.hash.split('/')[0]
    }
    ...
    function e(l) {
        ...
        var n, o, p, q, m = l.data('animation')
            .toString();
        if (-1 != m.indexOf('-')) {
            var r = m.split('-');
    ...
    return {
        init: function (l) {
            a('.pt-page')
                ...
                .each(function () {
                    var q = a(this);
                    q.data('current', 0), q.data('isAnimating', !1), q.children('.pt-page')
                        .eq(0)
                        .addClass('pt-page-current')
                }), a('.pt-trigger')
                .click(function () {
                    var q = a(this);
                    e(q), a(m + ' li')
                        .removeClass('active'), a(this.parentNode)
                        .addClass('active'), a('.pt-wrapper')
                        .animate({
                            scrollTop: 0
                        }, 300)
                    ...
                    if (location.hash) {
                        ...
                        var r = a(m + ' a[href*="' + location.hash.split('/')[0] + '"]'),
                            s = r[0];
                        s = a(s.parentNode), s.addClass('active'), e(r), a('.pt-wrapper')
                            .animate({
                                scrollTop: 0
                            }, 300), a('#page-ajax-loaded')
                            .addClass('fadeOutLeft'), a('#page-ajax-loaded > div')
                            .detach(), b()
                    }
                };
            var m = l.menu,
            ...
            a('#page')
                .append('<div id="page-ajax-loaded" class="page-ajax-loaded animated fadeInLeft"></div>'), b(), a(document)
                .on('click', '#portfolio-close-button', function () {
                    a('#page-ajax-loaded')
                        .addClass('fadeOutLeft'), a('#page-ajax-loaded > div')
                        .detach()
                })
